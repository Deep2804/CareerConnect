...
const AboutUs = () => {
  return (
    <div className="about-us">
      <h1>About Us</h1>
      <p>The journey of CareerConnect started with the coming together of visionary leaders from top institutions, who felt driven to revolutionize the campus hiring process and bridge the gap between students and their dream careers.</p>
      <p>
